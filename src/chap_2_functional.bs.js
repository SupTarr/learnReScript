...
SimpleTest.assertEqual(26, 26, "[exercise 1] Calculate discount for total amount of shopping cart");

function calculateDiscount(total) {
  if (total >= 500) {
    return total * 0.1 | 0;
  } else if (total >= 200) {
    return (total - 200 | 0) * 0.05 + 25 | 0;
  } else {
    return 0;
  }
}
...
var wrapedParagraph = makeDiv3(wrapTagAroundText("p", "Hello, world!"));
...
var betterWrapedParagraph = betterWrapTagAroundText("div", (function (param) {
        return param.repeat(2);
...
var myFinalString = myCharRepeat(6, /* "@" */64);
...
exports.wrapedParagraph = wrapedParagraph;
exports.betterWrapTagAroundText = betterWrapTagAroundText;
exports.betterWrapedParagraph = betterWrapedParagraph;
exports.myCharRepeat = myCharRepeat;
exports.myFinalString = myFinalString;
